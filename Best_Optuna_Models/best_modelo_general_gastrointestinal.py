...
def train_model(device, train_loader, val_loader):
    ...
    model = Net(num_filters1=64, num_filters2=128, num_filters3=512, kernel_size=5, dropout_rate=0.3984582043588385, num_classes=num_classes).to(device)
    optimizer = optim.Adam(model.parameters(), lr=0.0002439856678923934)
    ...
    # Guardar las pérdidas y precisión en un archivo Excel 📊
    ...
    df_loss.to_excel("C:/Users/Matias/Desktop/Tesis/BBDD_loss_gastrointestinal3.xlsx", index=False)
