...
class Net(nn.Module):
    def __init__(self, num_filters1, num_filters2, num_filters3, kernel_size, dropout_rate, num_classes, input_size=256):
        ...
        for _ in range(3):  # Dado que tenemos dos bloques de Conv + MaxPool
...
def objective(trial):
    ...
    model = Net(num_filters1, num_filters2,num_filters3, kernel_size, dropout_rate, num_classes).cuda()
