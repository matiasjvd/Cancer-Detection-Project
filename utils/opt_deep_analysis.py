...
def objective(trial, cancer='all'):
    ...
    num_layers = trial.suggest_int('num_layers', 1, 8)  # Hasta 8 capas
    num_fc_layers = trial.suggest_int('num_fc_layers', 1, 3)
    num_filters_list = [trial.suggest_categorical(f'num_filters_layer{i}', [32, 64, 128]) for i in range(num_layers)]
